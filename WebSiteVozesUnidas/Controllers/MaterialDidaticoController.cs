...
namespace WebSiteVozesUnidas.Controllers
{
    public class MaterialDidaticoController : Controller
    {
        ...
        public MaterialDidaticoController(VozesDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var materialDidatico = await _context.MaterialDidatico
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.CategoriaMaterial, "IdCategoriaMaterial", "Categoria");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            var materialDidatico = await _context.MaterialDidatico.FindAsync(id);
            if (materialDidatico == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            if (materialDidatico != null)
            {
                _context.MaterialDidatico.Remove(materialDidatico);
            }
